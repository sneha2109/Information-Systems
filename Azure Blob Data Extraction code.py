...
block_blob_service = BlockBlobService(account_name="coberblobstroage",account_key="HcQ4kmNm293ch00dK7O1LCjyMPdczGf4q3zx+IdQ26SfNRu/Z6M/2HG185hj8HUQO1Qg0ZTQMH4HtUZ6NWwLyg==")
...
generator = block_blob_service.list_blobs('flexy-data')
...
for blob in generator:
    ...
    if "/" in "{}".format(blob.name):
        ...
        #       #download the files to this directory
            ...
            block_blob_service.get_blob_to_path('flexy-data',blob.name,os.getcwd()+ "/" + head + "/" + tail)
...
#    block_blob_service.get_blob_to_path('cober-test-stand',blob.name,blob.name,blob.name,blob.name         
        ...
        block_blob_service.get_blob_to_path('flexy-data',blob.name,blob.name)
        print()
        block_blob_service.get_blob_to_path('flexy-data',blob.name,head + "/"+tail)